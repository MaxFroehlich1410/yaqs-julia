...
**Experiment**: experiment33
**Timestamp**: 2026-01-28 10:18:55
**Output directory**: `03_Nature_review_checks/results/experiment33`
...
| `jl_longrange_mode` | `TDVP` |
| `jl_tdvp_truncation` | `after_window` |
| `outdir` | `03_Nature_review_checks/results/experiment33` |
| `sites` | `1,4,5,6,7,8,12` |
| `state_jl` | `Neel` |
| `state_py` | `neel` |
| `trunc` | `0.0` |
