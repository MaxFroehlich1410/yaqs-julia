...
**Experiment**: experiment18
**Timestamp**: 2026-01-27 20:43:06
**Output directory**: `03_Nature_review_checks/results/experiment18`

## Command

```bash
julia --project=. 03_Nature_review_checks/run_three_method_comparison.jl --circuit=Heisenberg --L=10 --steps=8 --dt=0.1 --periodic=true --Jx=1.0 --Jy=1.0 --Jz=1.0 --h=0.5 --sites=1,4,5,6 --state_jl=Neel --state_py=neel --chi_max=256 --trunc=0 --trunc_mode=relative --jl_tdvp_truncation=after_window --jl_local_mode=TDVP --jl_longrange_mode=TDVP --jl_run_tebd=true --jl_run_src=true --jl_compare_bug=true --tag_jl=circuitTDVP --tag_jl_tebd=circuitTEBD --tag_jl_src=circuitSRC --tag_jl_bug=circuitBUG --outdir=03_Nature_review_checks/results
```
...
| `jl_longrange_mode` | `TDVP` |
| `jl_tdvp_truncation` | `after_window` |
| `outdir` | `03_Nature_review_checks/results/experiment18` |
| `sites` | `1,4,5,6` |
| `state_jl` | `Neel` |
| `state_py` | `neel` |
| `trunc` | `0.0` |
