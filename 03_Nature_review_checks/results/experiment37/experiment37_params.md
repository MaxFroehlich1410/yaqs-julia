...
**Experiment**: experiment37
**Timestamp**: 2026-01-30 23:44:31
**Output directory**: `03_Nature_review_checks/results/experiment37`
...
| `jl_longrange_mode` | `TDVP` |
| `jl_tdvp_truncation` | `after_window` |
| `outdir` | `03_Nature_review_checks/results/experiment37` |
| `sites` | `1,4,5,6,7,8,12` |
| `state_jl` | `Neel` |
| `state_py` | `neel` |
| `trunc` | `0.0` |
